...
try:
    ...
    logger.info("Applying Bag of Words (CountVectorizer) transformation.")
...
try:
    # Create DataFrames from Tfidf results
    logger.info("Creating DataFrames from Tfidf results.")
